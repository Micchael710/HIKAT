...
export interface Env {
  ...
  PTERODACTYL_APP_API_KEY?: string
  PTERODACTYL_SERVER_ID?: string
  PTERODACTYL_DEFAULT_OWNER_ID?: string
  PTERODACTYL_DEFAULT_EGG_ID?: string
  PTERODACTYL_EGG_VANILLA_ID?: string
  PTERODACTYL_EGG_FORGE_ID?: string
  PTERODACTYL_EGG_NEOFORGE_ID?: string
  PTERODACTYL_EGG_FABRIC_ID?: string
  PTERODACTYL_EGG_QUILT_ID?: string
  PTERODACTYL_DEFAULT_LOCATION_ID?: string
  PTERODACTYL_DEFAULT_DOCKER_IMAGE?: string
  PTERODACTYL_DEFAULT_STARTUP?: string
