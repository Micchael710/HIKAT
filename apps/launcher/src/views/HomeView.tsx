...
const STATS_TOP_EMPTY = 1020
const STATS_DELTA = STATS_TOP_WITH_NEWS - STATS_TOP_EMPTY // 390

const CUT_TOP_WITH_NEWS = 1310
const CUT_TOP_EMPTY = CUT_TOP_WITH_NEWS - STATS_DELTA // 920

export const CANVAS_H_NORMAL = 2460
export const CANVAS_H_EMPTY = CANVAS_H_NORMAL - STATS_DELTA // 2070
