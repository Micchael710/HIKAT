...
export default function ProfileView({
  ...
  const [, setLoadingMethods] = useState(true)
  ...
  const hasPassword = authMethods
    ? authMethods.some((m) => m.type === "PASSWORD")
    : true
  const externalMethods = authMethods
    ? authMethods.filter((m) => m.type === "GOOGLE" || m.type === "DISCORD")
    : []
          ...
          <div className="settings-card">
            ...
            >
              <div>
                ...
                >
                  {hasPassword ? t("profile.resetPassword") : t("profile.linkedMethods")}
                </div>
                <div
                  style={{
                    fontSize: 15,
                ...
                >
                  {hasPassword ? t("profile.resetPasswordDesc") : t("profile.oauthManagedDesc")}
                </div>
              </div>
