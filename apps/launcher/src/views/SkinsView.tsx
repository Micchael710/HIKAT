...
import { uploadPlayerSkin, deleteMyPlayerSkin } from "../services/skinService"
    ...
    if (skinType === "skin") {
      ...
      reader.onload = (ev) => {
        ...
        img.onload = async () => {
          ...
          try {
            const uploaded = await uploadPlayerSkin(file, "CLASSIC")
            ...
            const newSkin: SkinItem = {
              ...
              customImgUrl: uploaded.imageUrl,

              skinUrl: uploaded.imageUrl,

              model: uploaded.model.toLowerCase() as any,
            }

            setCustomSkins([newSkin])
            ...
            showToast(
              err?.message || "Error al sincronizar la skin con el servidor.",
              "error",
            )
          }
        }
